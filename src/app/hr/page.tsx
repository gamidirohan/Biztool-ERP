          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              ...
              <div className="flex items-center space-x-2">
                ...
                <h1 className="text-xl font-semibold text-gray-900 dark:text-white">HR Module</h1>
              </div>
            </div>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">
                Human resources management, payroll, recruitment, and employee development.
              </p>
              ...
              <div className="flex justify-center space-x-4">
                <Link href="/">
                  <Button className="bg-orange-600 hover:bg-orange-700 text-white">Return to Home</Button>
                </Link>
                <Link href="/login">
